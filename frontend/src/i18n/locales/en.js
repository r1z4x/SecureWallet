export default {
  ...
  auth: {
    ...
    registerSubtitle: 'Sign up to get started with your secure digital wallet!',
  ...
  admin: {
    ...
    replyPlaceholder: 'Type your reply message here...',
    ...
    ticketResolvedSuccessfully: 'Ticket resolved successfully!',
    errorSavingSettings: 'Error saving settings',
    errorSendingReply: 'Error sending reply',
    errorResolvingTicket: 'Error resolving ticket',
    // Notification system
    ...
    notificationsInQueue: '{count} notifications in queue',
    // Confirmation system
    confirmation: 'Confirmation',
    yes: 'Yes',
    no: 'No',
    confirmDeleteUser: 'Are you sure you want to delete this user? This action cannot be undone.',
    confirmResolveTicket: 'Are you sure you want to resolve this ticket?',
    deleteUser: 'Delete User',
    ...
    inactive: 'Inactive',
    // Reset Database
    confirmReset: 'Are you sure you want to reset the database? This will clear all data and recreate sample data. This action cannot be undone.',
    resetDatabase: 'Reset Database',
    reset: 'Reset',
    resetSuccess: 'Database reset successfully! All data has been cleared and recreated.',
    resetError: 'Failed to reset database',
    // Two-Factor Authentication
    twoFactorAuthDescription: 'Add an extra layer of security to user accounts',
    enabled: 'Enabled',
    disabled: 'Disabled',
    confirmEnableTwoFactor: 'Are you sure you want to enable Two-Factor Authentication for all users? This will require users to set up 2FA on their next login.',
    confirmDisableTwoFactor: 'Are you sure you want to disable Two-Factor Authentication? This will remove the security requirement for all users.',
    enableTwoFactor: 'Enable Two-Factor Authentication',
    disableTwoFactor: 'Disable Two-Factor Authentication',
    twoFactorEnabledSuccessfully: 'Two-Factor Authentication enabled successfully!',
    twoFactorDisabledSuccessfully: 'Two-Factor Authentication disabled successfully!',
    errorTogglingTwoFactor: 'Error toggling Two-Factor Authentication',
    sessionTimeout: 'Session Timeout',
    sessionTimeout30min: '30 minutes',
    sessionTimeout1hour: '1 hour',
    sessionTimeout2hours: '2 hours',
    sessionTimeout24hours: '24 hours',
    sessionTimeout1week: '1 week',
