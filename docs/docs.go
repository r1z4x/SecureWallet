    ...
    "definitions": {
        ...
        "models.Permission": {
            ...
            "properties": {
                ...
                "name": {
                    "description": "e.g., \"wallet:read\", \"wallet:write\", \"admin:users\"",
                    "type": "string"
                },
                "resource": {
                    "description": "e.g., \"wallet\", \"transaction\", \"user\"",
                    "type": "string"
                },
                "roles": {
                    "description": "Relationships",
        ...
        "models.Session": {
            ...
            "properties": {
                ...
                "device_name": {
                    "description": "e.g., \"Chrome on macOS\"",
                    "type": "string"
                },
                "expires_at": {
                    "type": "string"
                ...
                "is_active": {
                    "description": "Can be revoked without deletion",
                    "type": "boolean"
                },
                "last_accessed": {
                    "type": "string"
                ...
                "token_last_8": {
                    "description": "Last 8 chars for identification",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "oauth_accounts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.OAuthAccount"
                    }
                },
                "roles": {
                    "type": "array",
        ...
        "services.HealthStatus": {
            ...
            "properties": {
                "checks": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/services.Check"
                    }
                },
                "status": {
                    "type": "string"
